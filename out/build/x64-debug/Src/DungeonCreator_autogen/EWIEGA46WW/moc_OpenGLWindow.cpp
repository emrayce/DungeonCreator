...
namespace {
struct qt_meta_tag_ZN12OpenGLWindowE_t {};
} // unnamed namespace

template <> constexpr inline auto OpenGLWindow::qt_create_metaobjectdata<qt_meta_tag_ZN12OpenGLWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<OpenGLWindow, qt_meta_tag_ZN12OpenGLWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject OpenGLWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12OpenGLWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12OpenGLWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12OpenGLWindowE_t>.metaTypes,
    nullptr
} };
...
void *OpenGLWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12OpenGLWindowE_t>.strings))
